...
- 강제 진행 기능 (기존 fp) — 설계: [2026-09-23 강제 진행 설계](superpowers/specs/2026-09-23-force-progress-design.md)
...
- 에이전트의 설정 파일 변경 — 설계: [2026-09-23 .dflow 설정 설계](superpowers/specs/2026-09-23-dflow-config-design.md)
  - .env에서  .dflow 로 바꾸자.
...
- 하나의 레포에 2개의 팀장은 실행 안되도록 하자.  1레포 1팀장, 만약 다른 컴퓨터에 있으면 된다.
...
- 병렬 Task 머지 충돌로 팀 전체가 멈추는 문제를 풀자. 지금은 충돌 하나가 그 뒤 의존 사슬 전체를 세운다. 원인 분석: [2026-09-21 병렬 머지 충돌 분석](agent/2026-09-21-parallel-merge-conflict-analysis.md)

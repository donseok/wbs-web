...
project: MES
module: mes-lg
attach: PH-03/SYS-LG            # 골격(docs/mes/skel/wbs.md)의 부착점 — 이 노드의 자식으로 업로드된다
...
<!-- 작성 규칙 (계약: .claude/skills/dflow-wbs-nlevel/SKILL.md)
  ...
  - ID 채번: {접두}-{SYS}-{경로꼬리}-{순번} — 예: TSK-LG-XX-PR-01
...
### WP-LG-XX-UI: 화면
- [ ] TSK-LG-XX-UI-01: ...
## SUB-LG-L2IF: L2 I/F        ← 공정 축 (해당 시스템만)
## SUB-LG-ERPIF: ERP I/F      ← 업무 축 (if-id 로 대장 연결)
-->

...
| wbs-wsf 스킬 | `docs/superpowers/2026-08-11-kickoff-wbs-wsf.md` — ✅ **완료(2026-08-11)**: 실물 `.claude/skills/wbs-wsf/` (이 리포, 스크립트·레퍼런스 동봉 독립 패키지) | 프로그램 리스트 어댑터(DEV-04) 반영·검증 완료 |

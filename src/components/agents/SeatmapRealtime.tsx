...
// 허브·WBS 는 1~5초 안에 따라왔는데, 오피스만 채널을 듣지 않아 30초 폴링을 기다렸다.
...
// heartbeat·회수·재개 요청처럼 wbs_items 를 건드리지 않는 변화는 이 채널로 오지 않는다.
//
// 전체 오피스는 층이 여럿이라 채널도 여럿이다. 훅을 반복문에서 부를 수 없으니 층마다 빈 컴포넌트를

...
export function ProgressBar({
  ...
  return (
    <div className={`relative w-full overflow-visible rounded-full bg-line ${height}`} role="progressbar" aria-label={label ?? `진척 ${v}%`} aria-valuenow={v} aria-valuemin={0} aria-valuemax={100}>

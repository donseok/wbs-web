...
import {
  applyServerRow, rowSectionLabel, sortWeeklyRows, WEEKLY_CELL_KEYS, WEEKLY_CELL_MAX, WEEKLY_CELL_LABEL,
  WEEKLY_SECTIONS,
      ...
      <div className="space-y-4">
        ...
        <EmptyState
          ...
          description={canCreateRound
            ? `이전 주차에서 이월하거나 기본 시트(PMO·영업·관리회계·재무회계·품질 등 업무영역 ${WEEKLY_SECTIONS.length}개 구분)로 시작하세요. 이월하면 이전 주의 차주계획이 이번 주 금주실적 초안으로 들어옵니다.`

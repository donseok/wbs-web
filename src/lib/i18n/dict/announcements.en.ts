...
export const announcementsEn: Record<keyof typeof announcementsKo, string> = {
  ...
  'ann.form.milestone': 'Show on milestone timeline',
  'ann.form.milestoneDate': 'Milestone date',
  'ann.form.milestoneHint': 'When checked, this announcement appears on the dashboard milestone timeline on this date, independent of the publish window.',
  ...
  'ann.err.milestoneDate': 'Set the milestone date.',

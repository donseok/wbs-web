...
export const dashboardEn: Record<keyof typeof dashboardKo, string> = {
  ...
  'dash.issues.distribution': 'Status distribution',
  'dash.issues.byMega': 'By Mega area',
  'dash.issues.byMegaCols': 'count · mix · resolved',
  ...
  'dash.issues.trendTitle': 'Created vs resolved',

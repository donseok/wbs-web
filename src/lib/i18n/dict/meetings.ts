export const meetingsKo = {
  ...
  'meet.detail.body': '메모',
  'meet.detail.noBody': '작성된 메모가 없습니다.',
  ...
  'meet.form.notifyNoAttendees': '참석자를 선택하거나 추가 수신 이메일을 입력하면 메일을 보낼 수 있습니다.',
  'meet.form.extraEmails': '추가 수신 이메일',
  'meet.form.extraEmailsPlaceholder': '참석자 외 수신자 이메일 — 쉼표로 구분해 입력',
  'meet.form.extraEmailsInvalid': '추가 수신 이메일 형식을 확인하세요',
  'meet.form.extraEmailsMax': '추가 수신 이메일은 최대 {max}개까지 입력할 수 있습니다.',
  'meet.form.extraEmailsNotifyOff': '메일 보내기가 꺼져 있어 입력한 추가 수신 이메일로는 발송되지 않습니다. 보내려면 위 체크박스를 켜세요.',
  'meet.form.announce': '이 회의를 공지사항으로도 등록',
  'meet.form.announceRecurHint': '반복 회의는 첫 회차 1건만 공지됩니다.',
  'meet.form.announceOk': '회의가 공지사항으로 등록되었습니다.',
  'meet.form.announceFailed': '회의는 저장되었으나 공지 등록에 실패했습니다',
  'meet.notify.sending': '메일 보내는 중…',
  'meet.notify.toastTitle': '메일 발송 완료',
  'meet.notify.sent': '수신자 {n}명에게 회의 안내 메일을 보냈습니다.',
  'meet.notify.partial': '회의가 저장되었습니다. {n}명에게 발송했고, 다음 수신자는 제외했습니다 — {names}',
  'meet.notify.noneSent': '회의가 저장되었습니다. 보낼 수 있는 수신자가 없어 메일을 보내지 않았습니다.',

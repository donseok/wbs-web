export const minutesKo = {
  ...
  'min.commit.title': '약속 확인',
  'min.commit.subtitle': 'AI가 찾은 약속을 원문과 비교하고 담당·기한을 보완한 뒤 확인하세요.',
  'min.commit.tab.pending': '검토 필요',
  'min.commit.tab.completed': '처리 완료',
  'min.commit.extract': '약속 추출',
  'min.commit.reextract': '다시 추출',
  'min.commit.extracting': '추출 중…',
  'min.commit.extractFailed': '약속을 추출하지 못했습니다.',
  'min.commit.extractSuccess': '약속 추출 완료',
  'min.commit.empty.pending': '검토할 약속이 없습니다.',
  'min.commit.empty.completed': '처리 완료된 약속이 없습니다.',
  'min.commit.readOnly': '읽기 전용',
  'min.commit.stale.title': '재추출 필요',
  'min.commit.stale.desc': '회의일 또는 원문이 변경되어 이 후보를 확인할 수 없습니다.',
  'min.commit.status.pending': '검토 필요',
  'min.commit.status.confirmed': '확인 완료',
  'min.commit.status.rejected': '제외됨',
  'min.commit.field.text': '약속 내용',
  'min.commit.field.owner': '담당자',
  'min.commit.field.team': '담당팀',
  'min.commit.field.due': '기한',
  'min.commit.field.dueText': '원문 기한',
  'min.commit.missing.owner': '담당 확인',
  'min.commit.missing.due': '기한 확인',
  'min.commit.choice.ownerUnassigned': '담당 미정으로 확인',
  'min.commit.choice.dueUndecided': '기한 미정으로 확인',
  'min.commit.value.ownerUnassigned': '담당 미정',
  'min.commit.value.dueUndecided': '기한 미정',
  'min.commit.source': '원문 근거',
  'min.commit.source.open': '원문 보기',
  'min.commit.source.unavailable': '원문 변경됨',
  'min.commit.action.confirm': '확인 완료',
  'min.commit.action.reject': '제외',
  'min.commit.action.reopen': '다시 검토',
  'min.commit.action.saving': '저장 중…',
  'min.commit.reviewFailed': '약속 검토 결과를 저장하지 못했습니다.',
  'min.commit.reviewConfirmed': '약속을 확인 완료했습니다.',
  'min.commit.reviewRejected': '약속 후보를 제외했습니다.',
  'min.commit.reviewReopened': '약속을 검토 대기로 되돌렸습니다.',
  'min.hl.add': '하이라이트',
...
export const minutesEn: Record<keyof typeof minutesKo, string> = {
  ...
  'min.commit.title': 'Commitment review',
  'min.commit.subtitle': 'Compare AI-found commitments with the source, complete the owner and due date, then confirm them.',
  'min.commit.tab.pending': 'Needs review',
  'min.commit.tab.completed': 'Completed',
  'min.commit.extract': 'Extract commitments',
  'min.commit.reextract': 'Extract again',
  'min.commit.extracting': 'Extracting…',
  'min.commit.extractFailed': "Couldn't extract commitments.",
  'min.commit.extractSuccess': 'Commitment extraction complete',
  'min.commit.empty.pending': 'No commitments need review.',
  'min.commit.empty.completed': 'No completed commitments yet.',
  'min.commit.readOnly': 'Read only',
  'min.commit.stale.title': 'Re-extraction required',
  'min.commit.stale.desc': 'The meeting date or source changed, so this suggestion cannot be confirmed.',
  'min.commit.status.pending': 'Needs review',
  'min.commit.status.confirmed': 'Confirmed',
  'min.commit.status.rejected': 'Excluded',
  'min.commit.field.text': 'Commitment',
  'min.commit.field.owner': 'Owner',
  'min.commit.field.team': 'Team',
  'min.commit.field.due': 'Due date',
  'min.commit.field.dueText': 'Source deadline',
  'min.commit.missing.owner': 'Check owner',
  'min.commit.missing.due': 'Check due date',
  'min.commit.choice.ownerUnassigned': 'Confirm owner undecided',
  'min.commit.choice.dueUndecided': 'Confirm due date undecided',
  'min.commit.value.ownerUnassigned': 'Owner undecided',
  'min.commit.value.dueUndecided': 'Due date undecided',
  'min.commit.source': 'Source evidence',
  'min.commit.source.open': 'View source',
  'min.commit.source.unavailable': 'Source changed',
  'min.commit.action.confirm': 'Confirm',
  'min.commit.action.reject': 'Exclude',
  'min.commit.action.reopen': 'Review again',
  'min.commit.action.saving': 'Saving…',
  'min.commit.reviewFailed': "Couldn't save the review.",
  'min.commit.reviewConfirmed': 'Commitment confirmed.',
  'min.commit.reviewRejected': 'Commitment suggestion excluded.',
  'min.commit.reviewReopened': 'Commitment returned to review.',

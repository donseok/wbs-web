...
export const minutesKo = {
  ...
  'min.err.uploadRollbackFail': '파일 업로드에 실패했습니다. 목록에서 해당 항목을 삭제하고 다시 시도해 주세요.',
...
export const minutesEn: Record<keyof typeof minutesKo, string> = {
  ...
  'min.err.uploadRollbackFail': 'File upload failed. Please delete the entry from the list and try again.',

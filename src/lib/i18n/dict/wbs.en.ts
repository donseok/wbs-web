...
export const wbsEn: Record<keyof typeof wbsKo, string> = {
  ...
  'wbs.depViewList': 'List',
  'wbs.depViewGraph': 'Graph',
  'wbs.depGraphOpenHint': 'Double-click to open this task',
  'wbs.depGraphMore': '+{n} more',
  'wbs.depGraphCollapse': 'Collapse',
  ...
  'wbs.detailPrev': 'Previous item',
  'wbs.detailNext': 'Next item',
  ...
  'wbs.agentOrderStart': 'Start',
  'wbs.agentOrderEnd': 'End',
  'wbs.agentOrderDuration': 'Time',
  'wbs.agentOrderStep': 'Step',
  'wbs.agentOrderTotal': 'Total',
  'wbs.agentOrderTokens': 'Tokens',
  'wbs.agentOrderTokIn': 'in',
  'wbs.agentOrderTokCacheW': 'cache write',
  'wbs.agentOrderTokCacheR': 'cache read',
  'wbs.agentOrderTokOut': 'out',
  'wbs.agentOrderInProgress': 'In progress',
  'wbs.agentOrderMinutes': '{n} min',
  'wbs.agentOrderPct': 'Progress',
  'wbs.agentOrderModelCol': 'Model',
  'wbs.agentOrderKindCompletion': 'Completion',

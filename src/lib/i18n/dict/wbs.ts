...
export const wbsKo = {
  ...
  'wbs.toastWeightRange': '가중치는 0~100 범위여야 합니다',
  ...
  'wbs.weightEqual': '균등',
  'wbs.editWeightTitle': '클릭하여 가중치 편집 — 0~100 (비우면 균등)',
...
export const wbsEn: Record<keyof typeof wbsKo, string> = {
  ...
  'wbs.toastWeightRange': 'Weight must be between 0 and 100',
  ...
  'wbs.editWeightTitle': 'Click to edit weight — 0–100 (empty = equal)',

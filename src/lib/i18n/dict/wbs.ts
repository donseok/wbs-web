...
export const wbsKo = {
  ...
  'wbs.startReady': '선행 충족 — 시작 가능',
  'wbs.startBlocked': '선행 {n}건 대기 중',
  'wbs.startUnknown': '선행 {n}건을 확인할 수 없음',
  'wbs.alreadyStarted': '이미 착수함',
  'wbs.depSatisfied': '충족',
  'wbs.depWaiting': '대기',
  ...
  // 행 상세 패널
  'wbs.detailSuffix': '상세',
  'wbs.detailPrev': '이전 항목',
  'wbs.detailNext': '다음 항목',
  ...
  'wbs.stageIm': '검수 대기',
  'wbs.stageXx': '완료',
  'wbs.stageLockedByOrder': '에이전트에 위임된 작업입니다. 단계는 승인·반려로 바뀝니다. 직접 바꾸려면 위임을 끄세요.',
  'wbs.stageNotWorkflow': '개발 워크플로 대상이 아니라 단계를 쓰지 않습니다.',
  ...
  'wbs.specAgentDelegateHint': '체크 = 발행. 주문이 생기고 폴링 중인 에이전트가 자동 착수한다. 해제 = 대기·작업 중 주문 취소(완료 보고는 취소되지 않음 — 아래에서 승인·반려)',
  'wbs.specAgentPromptLabel': '에이전트 프롬프트',
  'wbs.specAgentPromptHint': '위임 시 에이전트에 전달되는 지시문 — 포커스를 벗어나면 저장',
  'wbs.specAgentPromptPlaceholder': '예) 기존 API 계약을 깨지 말 것. 마이그레이션 없이 구현.',
  'wbs.agentOrderTitle': '에이전트 진행 상황',
  'wbs.agentOrderReady': '대기 중 — 아직 에이전트가 착수하지 않았습니다.',
  'wbs.agentOrderClaimed': '작업 중',
  'wbs.agentOrderStale': '응답 없음',
  'wbs.agentOrderReported': '완료 보고 — 승인 대기',
  ...
  'wbs.agentOrderStart': '시작',
  'wbs.agentOrderEnd': '종료',
  'wbs.agentOrderDuration': '시간',
  'wbs.agentOrderStep': '단계',
  'wbs.agentOrderTotal': '전체',
  'wbs.agentOrderTokens': '토큰',
  'wbs.agentOrderTokIn': '입력',
  'wbs.agentOrderTokCacheW': '캐시 쓰기',
  'wbs.agentOrderTokCacheR': '캐시 읽기',
  'wbs.agentOrderTokOut': '출력',
  'wbs.agentOrderInProgress': '진행 중',
  'wbs.agentOrderMinutes': '{n}분',
  'wbs.agentOrderPct': '진척',
  'wbs.agentOrderModelCol': '모델',
  'wbs.agentOrderKindCompletion': '완료',
  'wbs.agentOrderApprove': '승인',
  'wbs.agentOrderReject': '반려',
  'wbs.agentOrderRejectNote': '반려 사유 (필수)',
  'wbs.agentOrderUnapprove': '승인 취소',
  'wbs.agentOrderRework': '재작업 요청',
  'wbs.agentOrderReworkNote': '재작업 사유 (필수)',
  'wbs.agentOrderActionFailed': '처리에 실패했습니다',
  'wbs.agentOrderLoadFail': '진행 상황을 불러오지 못했습니다',

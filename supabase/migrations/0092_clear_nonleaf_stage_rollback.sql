-- 0092 rollback — 0092 가 남긴 change_logs 기록에서 상위 항목의 stage 를 되돌린다.
--
-- 0092 는 값을 지우는 마이그레이션이라 스키마 되돌리기가 아니라 데이터 복원이다.
-- 복원 재료는 0092 가 같은 트랜잭션에서 넣은 change_logs(user_id is null, field='stage',

-- supabase/migrations/0097_stage_credits_single_table_rollback.sql
-- 0097 되돌리기 — apply_workflow_event 를 0096 본문(카테고리별 if·doc 표, 항목 credit_key 로 표 선택)으로 되살린다.
-- 컬럼·CHECK 는 0097 이 건드리지 않았으므로 여기서도 건드리지 않는다.
